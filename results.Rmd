...
The results of this test indicate the only coefficient with significant results *(p < .05)* was for Employees ages 25 to 34. A plot of the means with confidence intervals helps to see the source of this effect.
...
Here too, we observe a significant relationship at the *(p < .05)* level.
